...
answer_start = ReplyKeyboardMarkup(resize_keyboard=True).add("Получить задание!").add('Добавить задание')
...
Inline_Date.add(Inline_Date_Up).add(Inline_Date_Bm).add(Inline_Date_Bt).add(Inline_Date_Bwd)\
